...
class Handles
{
    ...
    public function __construct($search = null)
    {
        if ($search)
        {
            if ($search instanceof \OpenProvider\Domain)
            {
    ...
    public function getByDomain(\OpenProvider\Domain $domain)
    {
        // get domain id
     ...
     * @param \OpenProvider\API $api
     * @param \OpenProvider\Domain $domain
     * @param type $domainId
     * @param type $useLocalHandle
     */
    public function importToWHMCS(\OpenProvider\API $api, \OpenProvider\Domain $domain, $domainId, $useLocalHandle)
    {
     ...
     */
    public function updateInWHMCS(\OpenProvider\API $api, \OpenProvider\Domain $domain, $domainId, $useLocalHandle, $domainInfo = null)
    {
        if (!$domainInfo) {
            $domainInfo = $api->retrieveDomainRequest($domain);
        }
